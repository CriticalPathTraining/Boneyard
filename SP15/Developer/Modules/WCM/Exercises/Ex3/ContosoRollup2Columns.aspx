...
<asp:Content ContentPlaceHolderId="PlaceHolderMain" runat="server">
	<div style="display: table; width: 100%">
		<div style="display: table-row; width: 100%">
			<div id="Div1" name="_invisibleIfEmpty" style="display: table-cell; width: 150px">
				<WebPartPages:WebPartZone runat="server" title="<%$Resources:cms,WebPartZoneTitle_Left%>" id="Left" orientation="Vertical" />
			</div>
			<div id="_invisibleIfEmpty" name="_invisibleIfEmpty" style="display: table-cell; width: 500px">
