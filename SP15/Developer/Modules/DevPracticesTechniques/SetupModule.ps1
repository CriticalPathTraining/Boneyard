# setup for SharePoint Developer Practices-Techniques Lab
Add-PSSnapin "Microsoft.SharePoint.PowerShell"

$siteDomain = "devpractices.wingtip.com"
$siteUrl = "http://$siteDomain"
$siteDisplayName = "SharePoint Developer Practices-Techniques Lab"
$siteTemplate = "DEV#0"
