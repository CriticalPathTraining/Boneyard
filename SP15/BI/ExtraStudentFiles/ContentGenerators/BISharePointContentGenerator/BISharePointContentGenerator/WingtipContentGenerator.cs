...
namespace BISharePointContentGenerator {
  ...
  public class WingtipContentGenerator {
    ...
    static string listProductsId;

    // customers list
    static Field fieldCustomerFirstName;
    static Field fieldCustomerLastName;
    static FieldCalculated fieldCustomerFullName;
    static Field fieldCustomerCompany;
    static Field fieldCustomerEmail;
    static Field fieldCustomerWorkPhone;
    static Field fieldCustomerHomePhone;
    static Field fieldCustomerAddress;
    static Field fieldCustomerCity;
    static Field fieldCustomerState;
    static Field fieldCustomerZipCode;
    static FieldChoice fieldCustomerGender;
    static FieldDateTime fieldCustomerBirthDate;
    static FieldDateTime fieldCustomerFirstPurchaseDate;
    static FieldDateTime fieldCustomerLastPurchaseDate;
    static ContentType ctypeCustomer;
    static List listCustomers;
    static string listCustomersId;

    // invoice list
    static Field fieldInvoiceNumber;
    static FieldLookup fieldCustomerLookup;
    static FieldDateTime fieldInvoiceDate;
    static FieldCurrency fieldInvoiceAmount;
    static FieldChoice fieldInvoiceType;
    static ContentType ctypeInvoice;
    static List listInvoices;
    static string listInvoicesId;

    // invoice details list
    static FieldLookup fieldInvoiceLookup;
    static FieldLookup fieldProductLookup;
    static FieldNumber fieldInvoiceDetailQuantity;
    static FieldCurrency fieldInvoiceDetailPrice;
    static ContentType ctypeInvoiceDetail;
    static List listInvoiceDetails;
    ...
    static void DeleteSiteColumn(string fieldName) {
      try {
    ...
    static public void CreateBILists() {
      ...
      CreateProductCategoriesTermset();
    ...
    static void DeleteAllWingtipTypes() {
      ...
      Console.WriteLine("Deleting existing lists and types...");
      DeleteList("Invoice Details");
      DeleteContentType("Invoice Detail");
      DeleteList("Invoices");
      DeleteContentType("Invoice");
      DeleteSiteColumn("ProductLookup");
      DeleteSiteColumn("InvoiceLookup");
      DeleteSiteColumn("CustomerLookup");

      DeleteList("Customers");
      DeleteContentType("Customer");

      DeleteSiteColumn("CustomerFullName");
    ...
    static void UploadProductImages() {
      ...
      Console.Write("Uploading Product Images");
    ...
    static void CreateProductsList() {
      ...
      listProductsId = listProducts.Id.ToString();
      ...
      foreach (var cType in listProducts.ContentTypes) {
        if (cType.Name.Equals("Item")) {
          cType.DeleteObject();
          clientContext.ExecuteQuery();
          break;
        }
    ...
    static void PopulateProductsList() {
      ...
      Console.Write("Adding Product items");
    ...
    static void CreateCustomerContentType() {

      fieldCustomerFirstName = CreateSiteColumn("CustomerFirstName", "First Name", "Text");
      fieldCustomerFirstName.Required = true;
      fieldCustomerFirstName.Update();
      clientContext.ExecuteQuery();
      clientContext.Load(fieldCustomerFirstName);
      clientContext.ExecuteQuery();

      fieldCustomerLastName = CreateSiteColumn("CustomerLastName", "Last Name", "Text");
      fieldCustomerLastName.Required = true;
      fieldCustomerLastName.Update();
      clientContext.ExecuteQuery();
      clientContext.Load(fieldCustomerLastName);
      clientContext.ExecuteQuery();

      fieldCustomerCompany = CreateSiteColumn("CustomerCompany", "Company", "Text");
      fieldCustomerCompany.Update();
      clientContext.ExecuteQuery();
      clientContext.Load(fieldCustomerCompany);
      clientContext.ExecuteQuery();

      fieldCustomerEmail = CreateSiteColumn("CustomerEmailAddress", "Email", "Text");
      fieldCustomerEmail.Update();
      clientContext.ExecuteQuery();
      clientContext.Load(fieldCustomerEmail);
      clientContext.ExecuteQuery();

      fieldCustomerWorkPhone = CreateSiteColumn("CustomerWorkPhone", "Work Phone", "Text");
      fieldCustomerWorkPhone.Update();
      clientContext.ExecuteQuery();
      clientContext.Load(fieldCustomerWorkPhone);
      clientContext.ExecuteQuery();

      fieldCustomerHomePhone = CreateSiteColumn("CustomerHomePhone", "Home Phone", "Text");
      fieldCustomerHomePhone.Update();
      clientContext.ExecuteQuery();
      clientContext.Load(fieldCustomerHomePhone);
      clientContext.ExecuteQuery();

      fieldCustomerAddress = CreateSiteColumn("CustomerAddress", "Address", "Text");
      fieldCustomerAddress.Update();
      clientContext.ExecuteQuery();
      clientContext.Load(fieldCustomerAddress);
      clientContext.ExecuteQuery();

      fieldCustomerCity = CreateSiteColumn("CustomerCity", "City", "Text");
      fieldCustomerCity.Update();
      clientContext.ExecuteQuery();
      clientContext.Load(fieldCustomerCity);
      clientContext.ExecuteQuery();

      fieldCustomerState = CreateSiteColumn("CustomerState", "State", "Text");
      fieldCustomerState.Update();
      clientContext.ExecuteQuery();
      clientContext.Load(fieldCustomerState);
      clientContext.ExecuteQuery();

      fieldCustomerZipCode = CreateSiteColumn("CustomerZipCode", "Zip Code", "Text");
      fieldCustomerZipCode.Update();
      clientContext.ExecuteQuery();
      clientContext.Load(fieldCustomerZipCode);
      clientContext.ExecuteQuery();

      fieldCustomerGender = clientContext.CastTo<FieldChoice>(CreateSiteColumn("CustomerGender", "Gender", "Choice"));
      string[] choicesCustomerGender = { "M", "F" };
      fieldCustomerGender.Choices = choicesCustomerGender;
      fieldCustomerGender.EditFormat = ChoiceFormatType.RadioButtons;
      fieldCustomerGender.Update();
      clientContext.ExecuteQuery();

      fieldCustomerBirthDate = clientContext.CastTo<FieldDateTime>(CreateSiteColumn("CustomerBirthDate", "Birth Date", "DateTime"));
      fieldCustomerBirthDate.DisplayFormat = DateTimeFieldFormatType.DateOnly;
      fieldCustomerBirthDate.Update();

      fieldCustomerFirstPurchaseDate = clientContext.CastTo<FieldDateTime>(CreateSiteColumn("CustomerFirstPurchaseDate", "First Purchase", "DateTime"));
      fieldCustomerFirstPurchaseDate.DisplayFormat = DateTimeFieldFormatType.DateOnly;
      fieldCustomerFirstPurchaseDate.Update();

      fieldCustomerLastPurchaseDate = clientContext.CastTo<FieldDateTime>(CreateSiteColumn("CustomerLastPurchaseDate", "Last Purchase", "DateTime"));
      fieldCustomerLastPurchaseDate.DisplayFormat = DateTimeFieldFormatType.DateOnly;
      fieldCustomerLastPurchaseDate.Update();

      ctypeCustomer = CreateContentType("Customer", "0x01");
      clientContext.Load(ctypeCustomer);
      clientContext.Load(ctypeCustomer.FieldLinks);
      clientContext.ExecuteQuery();


      foreach (FieldLink fieldLink in ctypeCustomer.FieldLinks) {
        if (fieldLink.Name.Equals("Title")) {
          fieldLink.Hidden = true;
          ctypeCustomer.Update(true);
          clientContext.ExecuteQuery();
        }
      }


      FieldLinkCreationInformation fieldLinkInfoCustomerFirstName = new FieldLinkCreationInformation();
      fieldLinkInfoCustomerFirstName.Field = fieldCustomerFirstName;
      ctypeCustomer.FieldLinks.Add(fieldLinkInfoCustomerFirstName);
      ctypeCustomer.Update(true);

      FieldLinkCreationInformation fieldLinkInfoCustomerLastName = new FieldLinkCreationInformation();
      fieldLinkInfoCustomerLastName.Field = fieldCustomerLastName;
      ctypeCustomer.FieldLinks.Add(fieldLinkInfoCustomerLastName);
      ctypeCustomer.Update(true);

      FieldLinkCreationInformation fieldLinkInfoCustomerCompany = new FieldLinkCreationInformation();
      fieldLinkInfoCustomerCompany.Field = fieldCustomerCompany;
      ctypeCustomer.FieldLinks.Add(fieldLinkInfoCustomerCompany);
      ctypeCustomer.Update(true);

      FieldLinkCreationInformation fieldLinkInfoCustomerEmail = new FieldLinkCreationInformation();
      fieldLinkInfoCustomerEmail.Field = fieldCustomerEmail;
      ctypeCustomer.FieldLinks.Add(fieldLinkInfoCustomerEmail);
      ctypeCustomer.Update(true);

      FieldLinkCreationInformation fieldLinkInfoCustomerWorkPhone = new FieldLinkCreationInformation();
      fieldLinkInfoCustomerWorkPhone.Field = fieldCustomerWorkPhone;
      ctypeCustomer.FieldLinks.Add(fieldLinkInfoCustomerWorkPhone);
      ctypeCustomer.Update(true);


      FieldLinkCreationInformation fieldLinkInfoCustomerHomePhone = new FieldLinkCreationInformation();
      fieldLinkInfoCustomerHomePhone.Field = fieldCustomerHomePhone;
      ctypeCustomer.FieldLinks.Add(fieldLinkInfoCustomerHomePhone);
      ctypeCustomer.Update(true);

      FieldLinkCreationInformation fieldLinkInfoCustomerAddress = new FieldLinkCreationInformation();
      fieldLinkInfoCustomerAddress.Field = fieldCustomerAddress;
      ctypeCustomer.FieldLinks.Add(fieldLinkInfoCustomerAddress);
      ctypeCustomer.Update(true);

      FieldLinkCreationInformation fieldLinkInfoCustomerCity = new FieldLinkCreationInformation();
      fieldLinkInfoCustomerCity.Field = fieldCustomerCity;
      ctypeCustomer.FieldLinks.Add(fieldLinkInfoCustomerCity);
      ctypeCustomer.Update(true);

      FieldLinkCreationInformation fieldLinkInfoCustomerState = new FieldLinkCreationInformation();
      fieldLinkInfoCustomerState.Field = fieldCustomerState;
      ctypeCustomer.FieldLinks.Add(fieldLinkInfoCustomerState);
      ctypeCustomer.Update(true);

      FieldLinkCreationInformation fieldLinkInfoCustomerZipCode = new FieldLinkCreationInformation();
      fieldLinkInfoCustomerZipCode.Field = fieldCustomerZipCode;
      ctypeCustomer.FieldLinks.Add(fieldLinkInfoCustomerZipCode);
      ctypeCustomer.Update(true);

      FieldLinkCreationInformation fieldLinkInfoCustomerGender = new FieldLinkCreationInformation();
      fieldLinkInfoCustomerGender.Field = fieldCustomerGender;
      FieldLink fieldLinkCustomerGender = ctypeCustomer.FieldLinks.Add(fieldLinkInfoCustomerGender);
      ctypeCustomer.Update(true);


      FieldLinkCreationInformation fieldLinkCustomerBirthDate = new FieldLinkCreationInformation();
      fieldLinkCustomerBirthDate.Field = fieldCustomerBirthDate;
      ctypeCustomer.FieldLinks.Add(fieldLinkCustomerBirthDate);
      ctypeCustomer.Update(true);

      FieldLinkCreationInformation fieldLinkInfoCustomerFirstPurchaseDate = new FieldLinkCreationInformation();
      fieldLinkInfoCustomerFirstPurchaseDate.Field = fieldCustomerFirstPurchaseDate;
      ctypeCustomer.FieldLinks.Add(fieldLinkInfoCustomerFirstPurchaseDate);
      ctypeCustomer.Update(true);

      FieldLinkCreationInformation fieldLinkInfoCustomerLastPurchaseDate = new FieldLinkCreationInformation();
      fieldLinkInfoCustomerLastPurchaseDate.Field = fieldCustomerLastPurchaseDate;
      ctypeCustomer.FieldLinks.Add(fieldLinkInfoCustomerLastPurchaseDate);
      ctypeCustomer.Update(true);
    ...
    static public void CreateCustomersList() {

      CreateCustomerContentType();
      ...
      listCustomersId = listCustomers.Id.ToString();

      listCustomers.ContentTypesEnabled = true;
      listCustomers.ContentTypes.AddExistingContentType(ctypeCustomer);
      listCustomers.Update();
      clientContext.Load(listCustomers.ContentTypes);
      clientContext.ExecuteQuery();

      foreach (var cType in listCustomers.ContentTypes) {
        if (cType.Name.Equals("Item")) {
          cType.DeleteObject();
          clientContext.ExecuteQuery();
          break;
      ...
      View viewCustomers = listCustomers.DefaultView;
      viewCustomers.ViewFields.Remove("LinkTitle");
      viewCustomers.ViewFields.Add("Edit");
      viewCustomers.Update();
      clientContext.ExecuteQuery();
      ...
      string fieldXML = @"<Field 
                            ...
                            Group=""Wingtip""
                            ResultType=""Text"" > 
                            <Formula>=[First Name]&amp;"" ""&amp;[Last Name]</Formula>
                            <FieldRefs>
                              <FieldRef Name=""CustomerFirstName""/>
                              <FieldRef Name=""CustomerLastName""/>
                            </FieldRefs>
                          </Field>";

      fieldCustomerFullName = clientContext.CastTo<FieldCalculated>(listCustomers.Fields.AddFieldAsXml(fieldXML, true, AddFieldOptions.AddToDefaultContentType));
      listCustomers.Update();

      viewCustomers.ViewFields.Add("CustomerFirstName");
      viewCustomers.ViewFields.Add("CustomerLastName");
      viewCustomers.ViewFields.Add("CustomerState");
      viewCustomers.ViewFields.Add("CustomerCity");
      viewCustomers.ViewFields.Add("CustomerGender");
      viewCustomers.ViewFields.Add("CustomerBirthDate");
      viewCustomers.ViewFields.Add("CustomerFirstPurchaseDate");
      viewCustomers.ViewFields.Add("CustomerLastPurchaseDate");
      viewCustomers.ViewFields.Add("CustomerCompany");
      viewCustomers.Update();
      clientContext.ExecuteQuery();
    ...
    static void CreateInvoiceContentType() {

      fieldCustomerLookup = clientContext.CastTo<FieldLookup>(CreateSiteColumn("CustomerLookup", "Customer", "Lookup"));
      fieldCustomerLookup.LookupList = listCustomersId;
      fieldCustomerLookup.LookupField = "Full_x0020_Name";
      fieldCustomerLookup.Update();
      clientContext.ExecuteQuery();
      clientContext.Load(fieldCustomerLookup);
      clientContext.ExecuteQuery();

      fieldInvoiceNumber = CreateSiteColumn("InvoiceNumber", "Invoice Number", "Text");
      fieldInvoiceNumber.Required = true;
      fieldInvoiceNumber.Update();
      clientContext.ExecuteQuery();
      clientContext.Load(fieldInvoiceNumber);
      clientContext.ExecuteQuery();

      fieldInvoiceDate = clientContext.CastTo<FieldDateTime>(CreateSiteColumn("InvoiceDate", "Invoice Date", "DateTime"));
      fieldInvoiceDate.DisplayFormat = DateTimeFieldFormatType.DateOnly;
      fieldInvoiceDate.Update();
      clientContext.ExecuteQuery();
      clientContext.Load(fieldInvoiceDate);
      clientContext.ExecuteQuery();

      fieldInvoiceAmount = clientContext.CastTo<FieldCurrency>(CreateSiteColumn("InvoiceAmount", "Invoice Amount", "Currency"));
      fieldInvoiceNumber.Required = true;
      fieldInvoiceNumber.Update();
      clientContext.ExecuteQuery();
      clientContext.Load(fieldInvoiceNumber);
      ...
      fieldInvoiceType = clientContext.CastTo<FieldChoice>(CreateSiteColumn("InvoiceType", "Invoice Type", "Choice"));
      string[] InvoiceTypeChoices = { "InPerson", "Online", "MailOrder" };
      fieldInvoiceType.Choices = InvoiceTypeChoices;
      fieldInvoiceType.Update();
      clientContext.ExecuteQuery();
      clientContext.Load(fieldInvoiceType);
      clientContext.ExecuteQuery();


      ctypeInvoice = CreateContentType("Invoice", "0x01");
      clientContext.Load(ctypeInvoice);
      clientContext.Load(ctypeInvoice.FieldLinks);
      clientContext.ExecuteQuery();


      foreach (FieldLink fieldLink in ctypeInvoice.FieldLinks) {
        if (fieldLink.Name.Equals("Title")) {
          fieldLink.Hidden = true;
          ctypeInvoice.Update(true);
          clientContext.ExecuteQuery();
        }
      }


      FieldLinkCreationInformation fieldLinkInfoCustomerLookup = new FieldLinkCreationInformation();
      fieldLinkInfoCustomerLookup.Field = fieldCustomerLookup;
      ctypeInvoice.FieldLinks.Add(fieldLinkInfoCustomerLookup);
      ctypeInvoice.Update(true);

      FieldLinkCreationInformation fieldLinkInfoInvoiceNumber = new FieldLinkCreationInformation();
      fieldLinkInfoInvoiceNumber.Field = fieldInvoiceNumber;
      ctypeInvoice.FieldLinks.Add(fieldLinkInfoInvoiceNumber);
      ctypeInvoice.Update(true);

      FieldLinkCreationInformation fieldLinkInfoInvoiceDate = new FieldLinkCreationInformation();
      fieldLinkInfoInvoiceDate.Field = fieldInvoiceDate;
      ctypeInvoice.FieldLinks.Add(fieldLinkInfoInvoiceDate);
      ctypeInvoice.Update(true);

      FieldLinkCreationInformation fieldLinkInfoInvoiceAmount = new FieldLinkCreationInformation();
      fieldLinkInfoInvoiceAmount.Field = fieldInvoiceAmount;
      ctypeInvoice.FieldLinks.Add(fieldLinkInfoInvoiceAmount);
      ctypeInvoice.Update(true);

      FieldLinkCreationInformation fieldLinkInfoInvoiceType = new FieldLinkCreationInformation();
      fieldLinkInfoInvoiceType.Field = fieldInvoiceType;
      ctypeInvoice.FieldLinks.Add(fieldLinkInfoInvoiceType);
      ctypeInvoice.Update(true);
    ...
    static public void CreateInvoicesList() {

      CreateInvoiceContentType();

      Console.WriteLine("Creating Invoices list...");

      ListCreationInformation listInformationInvoices = new ListCreationInformation();
      listInformationInvoices.Title = "Invoices";
      listInformationInvoices.Url = "Lists/Invoices";
      listInformationInvoices.QuickLaunchOption = QuickLaunchOptions.On;
      listInformationInvoices.TemplateType = (int)ListTemplateType.GenericList;
      listInvoices = site.Lists.Add(listInformationInvoices);
      listInvoices.OnQuickLaunch = true;
      listInvoices.Update();

      clientContext.Load(listInvoices);
      clientContext.ExecuteQuery();

      listInvoicesId = listInvoices.Id.ToString();


      listInvoices.ContentTypesEnabled = true;
      listInvoices.ContentTypes.AddExistingContentType(ctypeInvoice);
      listInvoices.Update();
      clientContext.Load(listInvoices.ContentTypes);
      clientContext.ExecuteQuery();

      foreach (var cType in listInvoices.ContentTypes) {
        if (cType.Name.Equals("Item")) {
          cType.DeleteObject();
          clientContext.ExecuteQuery();
          break;
      ...
      View viewInvoices = listInvoices.DefaultView;
      viewInvoices.ViewFields.Remove("LinkTitle");
      viewInvoices.ViewFields.Add("Edit");
      viewInvoices.ViewFields.Add("ID");
      viewInvoices.ViewFields.Add("CustomerLookup");
      viewInvoices.ViewFields.Add("InvoiceNumber");
      viewInvoices.ViewFields.Add("InvoiceDate");
      viewInvoices.ViewFields.Add("InvoiceAmount");
      viewInvoices.ViewFields.Add("InvoiceType");
      viewInvoices.Update();
    ...
    static void AddInvoice(int CustomerID, DateTime InvoiceDate, double InvoiceAmount, string InvoiceType, List<InvoiceDetail> InvoiceDetails) {

      // add a few sample products
      ListItem newInvoice = listInvoices.AddItem(new ListItemCreationInformation());
      FieldLookupValue CustomerLookupValue = new FieldLookupValue();
      CustomerLookupValue.LookupId = CustomerID;
      newInvoice["CustomerLookup"] = CustomerLookupValue;
      newInvoice["InvoiceDate"] = InvoiceDate;
      newInvoice["InvoiceAmount"] = Convert.ToDecimal(InvoiceAmount);
      newInvoice["InvoiceType"] = InvoiceType;
      newInvoice.Update();
      clientContext.Load(newInvoice);
      clientContext.ExecuteQuery();
      ...
      foreach (InvoiceDetail InvoiceDetail in InvoiceDetails) {
        InvoiceAmountTotal += InvoiceDetail.Price;
        ListItem newInvoiceDetail = listInvoiceDetails.AddItem(new ListItemCreationInformation());
        FieldLookupValue InvoiceLookupValue = new FieldLookupValue();
        InvoiceLookupValue.LookupId = newInvoiceId;
        newInvoiceDetail["InvoiceLookup"] = InvoiceLookupValue;
        FieldLookupValue ProductLookupValue = new FieldLookupValue();
        ProductLookupValue.LookupId = InvoiceDetail.ProductId;
        newInvoiceDetail["ProductLookup"] = ProductLookupValue;
        newInvoiceDetail["InvoiceDetailQuantity"] = InvoiceDetail.Quantity;
        newInvoiceDetail["InvoiceDetailPrice"] = Convert.ToDecimal(InvoiceDetail.Price);
        newInvoiceDetail.Update();
        clientContext.ExecuteQuery();
      }

      newInvoice["InvoiceAmount"] = InvoiceAmountTotal;
    ...
    static void CreateInvoiceDetailContentType() {

      fieldInvoiceLookup = clientContext.CastTo<FieldLookup>(CreateSiteColumn("InvoiceLookup", "Invoice", "Lookup"));
      fieldInvoiceLookup.LookupList = listInvoicesId;
      fieldInvoiceLookup.LookupField = "InvoiceNumber";
      fieldInvoiceLookup.Update();
      clientContext.ExecuteQuery();
      clientContext.Load(fieldInvoiceLookup);
      clientContext.ExecuteQuery();

      fieldProductLookup = clientContext.CastTo<FieldLookup>(CreateSiteColumn("ProductLookup", "Product", "Lookup"));
      fieldProductLookup.LookupList = listProductsId;
      fieldProductLookup.LookupField = "Title";
      fieldProductLookup.Update();
      clientContext.ExecuteQuery();
      clientContext.Load(fieldProductLookup);
      clientContext.ExecuteQuery();

      fieldInvoiceDetailQuantity = clientContext.CastTo<FieldNumber>(CreateSiteColumn("InvoiceDetailQuantity", "Quantity", "Number"));
      fieldInvoiceDetailQuantity.Update();
      clientContext.ExecuteQuery();
      clientContext.Load(fieldInvoiceDetailQuantity);
      clientContext.ExecuteQuery();

      fieldInvoiceDetailPrice = clientContext.CastTo<FieldCurrency>(CreateSiteColumn("InvoiceDetailPrice", "Price", "Currency"));
      fieldInvoiceNumber.Update();
      clientContext.ExecuteQuery();
      clientContext.Load(fieldInvoiceNumber);
      clientContext.ExecuteQuery();

      ctypeInvoiceDetail = CreateContentType("Invoice Detail", "0x01");
      clientContext.Load(ctypeInvoiceDetail);
      clientContext.Load(ctypeInvoiceDetail.FieldLinks);
      clientContext.ExecuteQuery();

      foreach (FieldLink fieldLink in ctypeInvoiceDetail.FieldLinks) {
        if (fieldLink.Name.Equals("Title")) {
          fieldLink.Hidden = true;
          ctypeInvoiceDetail.Update(true);
          clientContext.ExecuteQuery();
        }
      }

      FieldLinkCreationInformation fieldLinkInfoInvoiceLookup = new FieldLinkCreationInformation();
      fieldLinkInfoInvoiceLookup.Field = fieldInvoiceLookup;
      ctypeInvoiceDetail.FieldLinks.Add(fieldLinkInfoInvoiceLookup);
      ctypeInvoiceDetail.Update(true);

      FieldLinkCreationInformation fieldLinkInfoProductLookup = new FieldLinkCreationInformation();
      fieldLinkInfoProductLookup.Field = fieldProductLookup;
      ctypeInvoiceDetail.FieldLinks.Add(fieldLinkInfoProductLookup);
      ctypeInvoiceDetail.Update(true);

      FieldLinkCreationInformation fieldLinkInfoInvoiceDetailQuantity = new FieldLinkCreationInformation();
      fieldLinkInfoInvoiceDetailQuantity.Field = fieldInvoiceDetailQuantity;
      ctypeInvoiceDetail.FieldLinks.Add(fieldLinkInfoInvoiceDetailQuantity);
      ctypeInvoiceDetail.Update(true);

      FieldLinkCreationInformation fieldLinkInfoInvoiceDetailPrice = new FieldLinkCreationInformation();
      fieldLinkInfoInvoiceDetailPrice.Field = fieldInvoiceDetailPrice;
      ctypeInvoiceDetail.FieldLinks.Add(fieldLinkInfoInvoiceDetailPrice);
      ctypeInvoiceDetail.Update(true);
    ...
    static public void CreateInvoiceDetailsList() {

      CreateInvoiceDetailContentType();

      Console.WriteLine("Creating Invoices Details list...");

      ListCreationInformation listInformationInvoiceDetails = new ListCreationInformation();
      listInformationInvoiceDetails.Title = "Invoice Details";
      listInformationInvoiceDetails.Url = "Lists/InvoiceDetails";
      listInformationInvoiceDetails.QuickLaunchOption = QuickLaunchOptions.Off;
      listInformationInvoiceDetails.TemplateType = (int)ListTemplateType.GenericList;
      listInvoiceDetails = site.Lists.Add(listInformationInvoiceDetails);
      listInvoiceDetails.Update();

      clientContext.Load(listInvoiceDetails);
      clientContext.ExecuteQuery();


      listInvoiceDetails.ContentTypesEnabled = true;
      listInvoiceDetails.ContentTypes.AddExistingContentType(ctypeInvoiceDetail);
      listInvoiceDetails.Update();
      clientContext.Load(listInvoiceDetails.ContentTypes);
      clientContext.ExecuteQuery();

      foreach (var cType in listInvoiceDetails.ContentTypes) {
        if (cType.Name.Equals("Item")) {
          cType.DeleteObject();
          clientContext.ExecuteQuery();
          break;
      ...
      View viewInvoiceDetails = listInvoiceDetails.DefaultView;
      viewInvoiceDetails.ViewFields.Remove("LinkTitle");
      viewInvoiceDetails.ViewFields.Add("Edit");
      viewInvoiceDetails.ViewFields.Add("InvoiceLookup");
      viewInvoiceDetails.ViewFields.Add("ProductLookup");
      viewInvoiceDetails.ViewFields.Add("InvoiceDetailQuantity");
      viewInvoiceDetails.ViewFields.Add("InvoiceDetailPrice");
      viewInvoiceDetails.Update();

      clientContext.ExecuteQuery();

    }

    static void AddSampleContent() {

      Console.Write("Adding sample Customer items");

      DateTime runnerDate = new DateTime(2013, 3, 17);

      while (runnerDate < DateTime.Today) {
        runnerDate = runnerDate.AddDays(1);
        var customer = CustomerFactory.GetRandomCustomer();

        ListItem customerItem = listCustomers.AddItem(new ListItemCreationInformation());
        customerItem["CustomerFirstName"] = customer.FirstName;
        customerItem["CustomerLastName"] = customer.LastName;
        customerItem["CustomerCompany"] = customer.Company;
        customerItem["CustomerEmailAddress"] = customer.EmailAddress;
        customerItem["CustomerWorkPhone"] = customer.WorkPhone;
        customerItem["CustomerHomePhone"] = customer.HomePhone;
        customerItem["CustomerAddress"] = customer.Address;
        customerItem["CustomerCity"] = customer.City;
        customerItem["CustomerState"] = customer.State;
        customerItem["CustomerZipCode"] = customer.ZipCode;
        customerItem["CustomerGender"] = customer.Gender;
        customerItem["CustomerBirthDate"] = customer.BirthDate;
        customerItem["CustomerFirstPurchaseDate"] = runnerDate;
        customerItem["CustomerLastPurchaseDate"] = runnerDate;
        customerItem.Update();
        clientContext.Load(customerItem);
        clientContext.ExecuteQuery();
        Console.Write(".");

        int CustomerID = customerItem.Id;

        AddInvoice(CustomerID, runnerDate, customer.FirstInvoice.InvoiceAmount, customer.FirstInvoice.InvoiceType, customer.FirstInvoice.InvoiceDetails);
