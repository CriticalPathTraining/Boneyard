...
namespace BISharePointContentGenerator {
  class Program {
    ...
    static void Main() {
      ...
      Console.WriteLine("-----------------------------------------------");
      Console.WriteLine("-- Loading BI Sample Content into SharePoint --");
      Console.WriteLine("-----------------------------------------------");
      Console.WriteLine();
      ...
      WingtipContentGenerator.CreateBILists();
      ...
      Console.WriteLine();
      Console.WriteLine("The list for sample BI content have been created.");
