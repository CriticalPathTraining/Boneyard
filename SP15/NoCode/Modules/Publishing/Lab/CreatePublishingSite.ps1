cls
# setup for Publishing Lab
Add-PSSnapin "Microsoft.SharePoint.PowerShell"

# create blank site collection at root
Write-Host
Write-Host " Creating Publishing site at http://www.wingtip.com" -ForegroundColor Black -BackgroundColor Gray
...
Write-Host "It is now safe to close this window." -ForegroundColor White
