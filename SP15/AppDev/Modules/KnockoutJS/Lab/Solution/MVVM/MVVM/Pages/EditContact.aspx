        ...
        <form>
            <input id="identifier" data-bind="attr: { value: get_contact(0).get_id() }" type="hidden" />
              ...
              <tr>
                <td>First Name</td>
                <td>
                  <input id="firstName" data-bind="attr: { value: get_contact(0).get_fname() }" type="text" 
                         autofocus required placeholder="John" />
              ...
              <tr>
                <td>Last Name</td>
                <td>
                  <input id="lastName" data-bind="attr: { value: get_contact(0).get_lname() }" type="text" 
              ...
              <tr>
                <td>Phone Number</td>
                <td>
                  <input id="workPhone" data-bind="attr: { value: get_contact(0).get_phone() }" type="tel" 
              ...
              <tr>
                <td>
                  <div style="margin-top:5px;padding-top:5px;">
                    <button  value="Submit" id="updateButton" >Submit</button>
                  </div>
                </td>
              </tr>
	            </table>
