Clear-Host
Write-Host
Write-Host "Create new IIS site for Wingtip Web Services" -ForegroundColor Black -BackgroundColor Gray


$IisWebSiteName = "Wingtip Web Services"
$IisWebSitePath = "C:\inetpub\WingtipWebServices"
$hostHeader     = "webservices.wingtip.com"
$bindingPort    = 80
